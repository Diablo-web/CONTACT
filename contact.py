...
def OnSelected(event):
    ...
    #===================LABELS==============================
    lbl_title = Label(FormTitle, text="UPDATING CONTACTS", font=('arial', 16), bg="violet",  width = 300)
...
def AddNewWindow():
    ...
    #===================LABELS==============================
    lbl_title = Label(FormTitle, text="Adding New Contacts", font=('arial', 16), bg="aqua",  width = 300)
    lbl_title.pack(fill=X)
    lbl_firstname = Label(ContactForm, text="Firstname", font=('arial', 14), bd=5)
    lbl_firstname.grid(row=0, sticky=W)
    lbl_lastname = Label(ContactForm, text="Lastname", font=('arial', 14), bd=5)
    ...
    #==================BUTTONS==============================
    buttonaddcon = Button(ContactForm, text="Save", width=50, command=SubmitData)
    buttonaddcon.grid(row=6, columnspan=2, pady=10)
...
Top.pack(side=TOP)
Mid = Frame(root, width=500,  bg="royalblue")
Mid.pack(side=TOP)
MidLeft = Frame(Mid, width=100)
MidLeft.pack(side=LEFT, pady=10)
MidLeftPadding = Frame(Mid, width=370, bg="royalblue")
...
#============================LABELS======================================
lbl_title = Label(Top, text="Contact Management System", font=('arial', 16),bg="lightgreen", width=500)
lbl_title.pack(fill=X)

#============================ENTRY=======================================

#============================BUTTONS=====================================
buttonadd = Button(MidLeft, text=" ADD NEW", bg="lime", command=AddNewWindow)
buttonadd.pack()
buttondelete = Button(MidRight, text=" DELETE ", bg="red", command=DeleteData)
buttondelete.pack(side=RIGHT)
